...
<div class="col-12 col-md-8 mx-auto mt-4 animate-fadeIn">
    ...
    <div class="card shadow-sm border-0" style="border-radius: 12px; background: #ffffff;">
        ...
        <div class="card-header bg-transparent pt-4 pb-2 px-4" style="border-bottom: 1px solid rgba(194, 156, 85, 0.15);">
            ...
            <small class="text-muted">Modifica las credenciales y el estado del miembro del equipo.</small>
        </div>
        ...
        <div class="card-body p-4">
            <form method="post" action="<?= Paths::to('employees/update') ?>">
                ...
                <!-- Botones de Acción con espaciado y padding elegante -->
                <div class="d-flex justify-content-between align-items-center pt-3" style="border-top: 1px solid #f1f1f1;">
                    <a href="<?= Paths::to('employees') ?>" class="btn btn-second px-4 py-2 border fw-medium" style="border-radius: 8px;">
                        Cancelar
                    </a>
                    <button type="submit" class="btn btn-golden-all px-4 py-2 fw-semibold" style="border-radius: 8px; box-shadow: 0 4px 12px rgba(194, 156, 85, 0.2);">
